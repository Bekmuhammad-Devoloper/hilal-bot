      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0f0a2a] via-[#1a1145] to-[#0f0a2a] flex flex-col">
        <div className="flex-1 flex flex-col items-center justify-center px-6 pt-10 pb-6">
          ...
          <div className="w-full max-w-sm space-y-3 mb-8">
            {[
              { icon: "📚", title: "Eksklyuziv darslar", sub: "Haftada 2 ta yangi dars", colors: "from-indigo-500 to-purple-500", delay: "0.15s" },
              { icon: "🎥", title: "Video va matnlar", sub: "Savol-javoblar bilan", colors: "from-emerald-500 to-cyan-500", delay: "0.25s" },
              { icon: "🤝", title: "Turk tili muhiti", sub: "Fikrlash va muloqot imkoniyati", colors: "from-amber-500 to-orange-500", delay: "0.35s" },
            ].map((f, i) => (
              <div key={i} className="flex items-center gap-3 bg-white/[0.06] backdrop-blur-sm rounded-2xl px-5 py-4 border border-white/[0.06] fade-in-up" style={{ animationDelay: f.delay }}>
                <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-br ${f.colors} rounded-xl flex items-center justify-center`}><span className="text-lg">{f.icon}</span></div>
        ...
        <div className="px-5 space-y-3 pb-8">
          ...
          <div className="bg-white/[0.07] backdrop-blur-sm rounded-2xl border border-white/[0.08] overflow-hidden fade-in-up stagger-3">
            <button onClick={() => setScreen("terms")} className="w-full px-5 py-4 flex items-center justify-between border-b border-white/[0.06] active:bg-white/[0.05] transition-colors">
              <div className="flex items-center gap-3.5"><div className="w-9 h-9 bg-amber-500/15 rounded-xl flex items-center justify-center float-icon" style={{ animationDelay: "1s" }}><svg className="w-[18px] h-[18px] text-amber-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></div><span className="font-medium text-indigo-100 text-sm">Ommaviy oferta</span></div>
              <svg className="w-4 h-4 text-indigo-400/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </button>
            <button onClick={() => setScreen("faq")} className="w-full px-5 py-4 flex items-center justify-between border-b border-white/[0.06] active:bg-white/[0.05] transition-colors">
              <div className="flex items-center gap-3.5"><div className="w-9 h-9 bg-rose-500/15 rounded-xl flex items-center justify-center float-icon" style={{ animationDelay: "1.5s" }}><svg className="w-[18px] h-[18px] text-rose-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01" /></svg></div><span className="font-medium text-indigo-100 text-sm">FAQ</span></div>
              <svg className="w-4 h-4 text-indigo-400/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </button>
            <button onClick={() => setScreen("contact")} className="w-full px-5 py-4 flex items-center justify-between active:bg-white/[0.05] transition-colors">
              <div className="flex items-center gap-3.5"><div className="w-9 h-9 bg-sky-500/15 rounded-xl flex items-center justify-center float-icon" style={{ animationDelay: "2s" }}><svg className="w-[18px] h-[18px] text-sky-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg></div><span className="font-medium text-indigo-100 text-sm">Aloqa</span></div>
              <svg className="w-4 h-4 text-indigo-400/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg>
            </button>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0f0a2a] via-[#1a1145] to-[#0f0a2a] p-5 pb-10">
        ...
        <div className="space-y-4 fade-in-up">
          {[
            ...
            <div key={i} className="bg-white/[0.07] backdrop-blur-sm rounded-2xl p-4 border border-white/[0.08]"><h3 className="text-white font-semibold text-sm mb-2">{item.icon} {item.title}</h3><p className="text-indigo-300/50 text-xs leading-relaxed">{item.text}</p></div>
          ))}
        </div>
        <div className="mt-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-5 border border-indigo-400/15 fade-in-up">
          ...
          <div className="space-y-3">
            <a href="https://t.me/hilaledu" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/[0.07] rounded-xl p-3 border border-white/[0.08] active:bg-white/[0.12] transition-colors"><div className="w-10 h-10 bg-blue-500/15 rounded-xl flex items-center justify-center"><span className="text-lg">✈️</span></div><div><p className="text-white text-sm font-medium">Telegram</p><p className="text-indigo-300/50 text-xs">@hilaledu</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></a>
            <a href="tel:+99855519787878" className="flex items-center gap-3 bg-white/[0.07] rounded-xl p-3 border border-white/[0.08] active:bg-white/[0.12] transition-colors"><div className="w-10 h-10 bg-emerald-500/15 rounded-xl flex items-center justify-center"><span className="text-lg">📱</span></div><div><p className="text-white text-sm font-medium">Telefon raqam</p><p className="text-indigo-300/50 text-xs">55-519-78-78</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></a>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#0f0a2a] via-[#1a1145] to-[#0f0a2a] p-5 flex flex-col">
        ...
        <div className="text-center mb-4 fade-in-up stagger-3">
          <button onClick={() => { setPrevScreen("payment"); setScreen("terms"); }} className="text-indigo-400/60 text-xs underline underline-offset-2 mb-3 active:text-indigo-300 transition-colors">📄 Ommaviy oferta shartlari</button>
