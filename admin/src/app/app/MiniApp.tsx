    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#0f0a2a] via-[#1a1145] to-[#0f0a2a] p-5 pb-10">
        ...
        <div className="space-y-4 fade-in-up">
          {[
            { iconSvg: <svg className="w-4.5 h-4.5 text-amber-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></svg>, title: "1. Obuna narxi va to'lov", text: "Kanalga kirish oylik obuna asosida ishlaydi. To'lov har 30 kunda avtomatik ravishda yechib olinadi. To'lov Payme yoki Click orqali amalga oshiriladi.", color: "from-amber-500/20 to-orange-500/20 border-amber-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-cyan-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182" /></svg>, title: "2. Avtomatik yechib olish", text: "Har oy belgilangan summa avtomatik ravishda kartangizdan yechib olinadi. Obuna faol bo'lgan davr mobaynida to'lov avtomatik davom etadi.", color: "from-cyan-500/20 to-teal-500/20 border-cyan-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-rose-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>, title: "3. Bekor qilish tartibi", text: "Obunani istalgan vaqtda bekor qilish mumkin. Bekor qilish keyingi to'lov davridan kuchga kiradi. Joriy davr oxirigacha kanaldan foydalanish mumkin.", color: "from-rose-500/20 to-red-500/20 border-rose-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-emerald-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, title: "4. Pulni qaytarish", text: "Foydalanilgan davr uchun to'lov qaytarilmaydi. Obuna bekor qilinsa, joriy oylik davr tugaguncha xizmatdan foydalanishingiz mumkin.", color: "from-emerald-500/20 to-green-500/20 border-emerald-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-violet-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" /></svg>, title: "5. Kanal kontenti", text: "Kanaldagi barcha materiallar mualliflik huquqi bilan himoyalangan. Kontentni uchinchi shaxslarga tarqatish, nusxalash yoki qayta nashr qilish qat'iyan taqiqlanadi.", color: "from-violet-500/20 to-purple-500/20 border-violet-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-orange-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" /></svg>, title: "6. Qoidabuzarlik", text: "Shartlarni buzgan foydalanuvchilarning obunasi ogohlantirishsiz bekor qilinishi mumkin. Bunday hollarda to'lov qaytarilmaydi.", color: "from-orange-500/20 to-amber-500/20 border-orange-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-blue-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" /></svg>, title: "7. O'zgarishlar", text: "Ma'muriyat istalgan vaqtda ushbu shartlarni yangilash huquqiga ega. O'zgarishlar haqida foydalanuvchilarga oldindan xabar beriladi.", color: "from-blue-500/20 to-indigo-500/20 border-blue-500/10" },
            { iconSvg: <svg className="w-4.5 h-4.5 text-sky-300" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>, title: "8. Aloqa", text: "Savollar yoki muammolar bo'lsa, biz bilan bog'laning. Biz sizga yordam berishdan mamnunmiz.", color: "from-sky-500/20 to-blue-500/20 border-sky-500/10" },
          ].map((item, i) => (
            <div key={i} className={`bg-gradient-to-br ${item.color} backdrop-blur-sm rounded-2xl p-4 border`}><div className="flex items-center gap-2.5 mb-2"><div className="w-7 h-7 bg-white/10 rounded-lg flex items-center justify-center">{item.iconSvg}</div><h3 className="text-white font-semibold text-sm">{item.title}</h3></div><p className="text-indigo-300/50 text-xs leading-relaxed pl-[38px]">{item.text}</p></div>
          ))}
        </div>
        <div className="mt-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-5 border border-indigo-400/15 fade-in-up">
          ...
          <div className="space-y-3">
            <a href="https://t.me/hilaledu" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/[0.07] rounded-xl p-3 border border-white/[0.08] active:bg-white/[0.12] transition-colors"><div className="w-10 h-10 bg-gradient-to-br from-sky-500/20 to-blue-500/20 rounded-xl flex items-center justify-center border border-sky-500/10"><svg className="w-5 h-5 text-sky-400" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg></div><div><p className="text-white text-sm font-medium">Telegram</p><p className="text-indigo-300/50 text-xs">@hilaledu</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></a>
            <a href="tel:+99855519787878" className="flex items-center gap-3 bg-white/[0.07] rounded-xl p-3 border border-white/[0.08] active:bg-white/[0.12] transition-colors"><div className="w-10 h-10 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-xl flex items-center justify-center border border-emerald-500/10"><svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" /></svg></div><div><p className="text-white text-sm font-medium">Telefon raqam</p><p className="text-indigo-300/50 text-xs">55-519-78-78</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></a>
          </div>
        </div>
  ...
  if (screen === "contact") {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#0f0a2a] via-[#1a1145] to-[#0f0a2a] p-5">
        ...
        <div className="space-y-4 fade-in-up">
          <a href="https://t.me/hilal_admin" target="_blank" rel="noopener noreferrer" className="block bg-white/[0.07] backdrop-blur-sm rounded-2xl p-5 border border-white/[0.08] active:bg-white/[0.1] transition-colors"><div className="flex items-center gap-4"><div className="w-12 h-12 bg-gradient-to-br from-sky-500/20 to-blue-600/20 rounded-2xl flex items-center justify-center border border-sky-500/10 shadow-lg shadow-sky-500/5"><svg className="w-6 h-6 text-sky-400" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg></div><div><p className="text-white font-semibold text-sm">Telegram Admin</p><p className="text-indigo-300/50 text-xs mt-0.5">@hilal_admin</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></div></a>
          <a href="https://t.me/hilal_bot_channel" target="_blank" rel="noopener noreferrer" className="block bg-white/[0.07] backdrop-blur-sm rounded-2xl p-5 border border-white/[0.08] active:bg-white/[0.1] transition-colors"><div className="flex items-center gap-4"><div className="w-12 h-12 bg-gradient-to-br from-indigo-500/20 to-violet-500/20 rounded-2xl flex items-center justify-center border border-indigo-500/10 shadow-lg shadow-indigo-500/5"><svg className="w-6 h-6 text-indigo-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38c-.551.318-1.26.117-1.527-.461a20.845 20.845 0 01-1.44-4.282m3.102.069a18.03 18.03 0 01-.59-4.59c0-1.586.205-3.124.59-4.59m0 9.18a23.848 23.848 0 018.835 2.535M10.34 6.66a23.847 23.847 0 008.835-2.535m0 0A23.74 23.74 0 0018.795 3m.38 1.125a23.91 23.91 0 011.014 5.395m-1.014 8.855c-.118.38-.245.754-.38 1.125m.38-1.125a23.91 23.91 0 001.014-5.395m0-3.46c.495.413.811 1.035.811 1.73 0 .695-.316 1.317-.811 1.73m0-3.46a24.347 24.347 0 010 3.46" /></svg></div><div><p className="text-white font-semibold text-sm">Rasmiy kanal</p><p className="text-indigo-300/50 text-xs mt-0.5">@hilal_bot_channel</p></div><svg className="w-4 h-4 text-indigo-400/30 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" /></svg></div></a>
          <div className="bg-white/[0.07] backdrop-blur-sm rounded-2xl p-5 border border-white/[0.08]"><div className="flex items-center gap-4"><div className="w-12 h-12 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-2xl flex items-center justify-center border border-emerald-500/10 shadow-lg shadow-emerald-500/5"><svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg></div><div><p className="text-white font-semibold text-sm">Email</p><p className="text-indigo-300/50 text-xs mt-0.5">support@hilalbot.uz</p></div></div></div>
          <div className="bg-white/[0.07] backdrop-blur-sm rounded-2xl p-5 border border-white/[0.08]"><div className="flex items-center gap-4"><div className="w-12 h-12 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-2xl flex items-center justify-center border border-amber-500/10 shadow-lg shadow-amber-500/5"><svg className="w-6 h-6 text-amber-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div><div><p className="text-white font-semibold text-sm">Ish vaqti</p><p className="text-indigo-300/50 text-xs mt-0.5">Dushanba - Shanba, 9:00 - 18:00</p></div></div></div>
        </div>
      </div>
    );
  }
