        ...
        <div className="space-y-6">
          ...
          <section className="bg-white/[0.07] backdrop-blur-sm rounded-2xl p-6 border border-white/[0.08]">
            ...
            <div className="text-indigo-200/60 text-sm leading-relaxed space-y-3">
              <p>1.1. Ushbu ommaviy oferta (bundan buyon — &quot;Oferta&quot;) <strong className="text-white">Hilal Edu</strong> platformasi (bundan buyon — &quot;Xizmat ko{"'"}rsatuvchi&quot;) tomonidan jismoniy shaxslarga (bundan buyon — &quot;Foydalanuvchi&quot;) taqdim etiladigan xizmatlar shartlarini belgilaydi.</p>
              <p>1.2. Xizmat ko{"'"}rsatuvchi: <strong className="text-white">G{"'"}ulomjon Sobirov</strong> (Hilal Edu loyihasi asoschisi).</p>
              <p>1.3. Platformada ro{"'"}yxatdan o{"'"}tish yoki to{"'"}lov amalga oshirish orqali Foydalanuvchi ushbu Oferta shartlarini to{"'"}liq qabul qiladi.</p>
              <p>1.4. Xizmat Telegram bot (<strong className="text-white">@oson_turktili_bot</strong>) va bog{"'"}liq web-ilova orqali ko{"'"}rsatiladi.</p>
            </div>
          </section>
